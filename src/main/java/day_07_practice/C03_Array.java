...
public class C03_Array {
    public static void main(String[] args) {
        ...
        for (int i =0; i<4; i++){ //kullanıcıdan 4 tane rakam alacağımız için 0dan 4'e kadar for döngüsüne aldık.
            System.out.println("Bir Rakam Giriniz");
            int rakam = scan.nextInt();

            arr[i]=rakam; //kullanıcıdan aldığımız her rakamı sırasıyla array'e esayn ettik.
