...
public class MultiDimensionalArray01 {
    ...
    public static void main(String[] args) {
        ...
        //Multidimensional arraylari console a yazdirmak icin "toStrin()" degil "deepToString()"methodunu kullaniriz.
        System.out.println(Arrays.deepToString(names));//[[A, K], [P, M], [C, Z]]

        //Multidimensional array icinden specisik bir eleman nasil yazdirilir?
        ...
        //Example 4: İki boyutlu bir array i tek boyutlu bir array'e ceviriniz.
        ...
        //3.Step: Iki boyutlu arraydeki elemanlari tek boyutlu array'e transfer etmeliyim.
        int idx = 0;
