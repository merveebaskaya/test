...
public class HashMap01 {
    ...
    public static void main(String[] args) {
        ...
        //Bu yontem value guncellemede kullanilabilir.Buna "overwrite"(üstüne yazmak) denir.
        stdAges.put("Tom", 83);
        ...
        //replace("Angelina", 57, 61); methodu Map icinde "Angelina" 57 varsa 57'i 61'e donusturur yoksa degistirmez.
        stdAges.replace("Angelina", 58, 61);
        System.out.println(stdAges);//{Tom=83, Angelina=61, Ajda=77, Brad=58, Ezel=39}

        //putIfAbsent("Ali",60); Map'te "Ali" key olarak yoksa Mar'e Ali=60 ekler varsa eklemez.
        stdAges.putIfAbsent("Ali",60);
        System.out.println(stdAges);//{Tom=83, Angelina=61, Ajda=77, Brad=58, Ezel=39, Ali=60}

        //getOrDefault("Ayse", 0); methodu Map'de varolan "key"ler icin "get() methodu" ayni ciktiyi verir.
        ...
        //containsValue(77); methodu value'larin 77 nin olup olmadigini kontrol eder.
        System.out.println(stdAges.containsValue(77)); //true
        System.out.println(stdAges.containsValue(99)); //false

        //containsKey(Ali); methodu key'lerin Ali nin olup olmadigini kontrol eder.
