...
public class MethodCreation01 {
    ...
    //Ornek 4: Verilen bir ondalık sayının kupunu hesaplayan methodu olusturup kullanınız.
    //NOTE:ACCESS MODIFIER'I default YAPMAK icin access modifier yazmayınız.
     static double getCube(double a){
          return a*a*a;
    }
    //Ornek 5: Girilen bir kelimeyi ekrana yazdıran bir method olusturup kullanınız.
