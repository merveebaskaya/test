...
public class E03 {
    ...
    2)"throws" method signature satirinda bir veya birden fazla Exception ile 1 kere kullanilir.
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("Negatives ages are not valid");
        }

        printAge(-9);

    }
    //Example 1: Kullanicidan alinan yasi konsola yazdiran methodu olusturunuz.
