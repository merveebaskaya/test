...
public class Animal {
    ...
    /*
    1)eat(){} method'u cok class'in kullanilmasi gerek methodu'lari her class'a ayri ayri
    yazarsak;
    ...
    v)Her class'in icine method'u tekrar tekrar yazmak "atomic yapiya" tertstir.
    2)private class member'lar child class'lar tarafindan kullnilamaz.
      ...
      protected class member'lar farkli package'de olsalar child class'lar tarafindan kullanilabilir.
