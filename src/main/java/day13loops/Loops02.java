...
public class Loops02 {
    ...
    public static void main(String[] args) {
        ...
        for (int i=0; i<s.length(); i++){
           ...
           if (ch>='a' && ch<='z'){
               continue; //boşveeeeer // loop yaparken bazi elemanlari isleme sokmamak icin "continue"kullanilir.
           }else {
               System.out.print(ch);
           }
        }
        //"break" ile "continue" arasindaki fark nedir?
        //"break" switch'in dışına çıkmak icin veya loop'u kırmak icin kullanilir.
