...
public class C03_Array {
     ...
     */
        ...
        for (int i = 0; i <arr1.length ; i++) {//distaki array'lerin kisa olaninin sayisinca donguye alacagim.

            if(arr1[i].length<arr2[i].length){//arr1[i] indexindeki dis arrayin eleman uzunlugu ile
                                              // arr2'nin i. indexindeki dıs arrayin eleman uzunlugunu karsilastirdik
                sinir = arr1[i].length;
            }else {
                sinir = arr2[i].length;
            }
