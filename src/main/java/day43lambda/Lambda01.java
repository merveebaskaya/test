...
public class Lambda01 {
    ...
    //Example 2: En azz bir kurs isminin QA icerip icermedigini kontrol eden method'u olusturunuz.
    ...
    //Example 4: Average score'u en dusuk olan ilk iki course disindaki tum kurslari return eden methodu olusturunuz.
    ...
    //Example 6: Ogrenci sayisi 150'den az olan kurslari return eden methodu'u olusturunuz.
    public static List<Course> getCourseWhoseRegisteredStdLessThanANumber(List<Course>courseList,int numOfStd){
       return courseList.
               stream().
               filter(t->t.getNumOfStudent()<numOfStd).
               collect(Collectors.toList());
    }
