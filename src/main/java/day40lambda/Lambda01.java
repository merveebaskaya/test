...
public class Lambda01 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println();
        bykHrflSonHarfArtanDistinct(iller);
        System.out.println();
        ...
        public static void bykHrflSonHarfArtanDistinct(List<String>iller){
            System.out.print("2) ");
        iller.
                stream().
                distinct().
        ...
        public static void bykHrfLenghtArtanDistinctLenghtAlfabetikSira(List<String>iller){
            ...
            iller.
                    ...
                    forEach(System.out::println); // Method Referance() yontemi
        }
    ...
    public static List<String> krktrSysBesFzlOlanlariSil(List<String>iller){
        ...
        return iller;
         ...
         // 5)"H" ile baslayan veya "u"(//r yerine) ile biten elemanlari siliniz
